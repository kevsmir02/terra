  ...
  variants: {
    dark: {
      ...
      terminal: {
        ...
        ansi: [
          "#090618", "#e25c5c", "#76946a", "#c0a36e",
          "#7e9cd8", "#957fb8", "#6a9589", "#c8c093",
          "#727169", "#ff5d62", "#98bb6c", "#e6c384",
    ...
    light: {
      ...
      terminal: {
        ...
        ansi: [
          "#1f1f28", "#bd354a", "#577036", "#706938",
          "#4d689a", "#a24c6a", "#4d6e69", "#545464",
          "#85847c", "#d7474b", "#6b8d5c", "#836f4a",
          "#5b87b3", "#624c83", "#5e857a", "#43436c",
        ],
      },
    },
  },
