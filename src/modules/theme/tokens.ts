...
export const TOKENS: readonly TokenDef[] = [
  ...
  { key: "colors.cardForeground", cssVar: "--card-foreground", group: "colors", kind: "textColor", deps: ["colors.foreground"], derive: (d) => { const v = d["colors.foreground"]; return v ? ensureContrast(v, d["colors.background"] || "#000", 4.5) : undefined; }, doc: "Text on card surfaces." },
  ...
  { key: "syntax.variable", cssVar: "--syntax-variable", group: "syntax", kind: "color", deps: ["colors.foreground"], derive: (d) => { const v = d["colors.foreground"]; return v ? ensureContrast(v, d["colors.background"] || "#000", 4.5) : undefined; }, doc: "Variable color." },
  ...
  { key: "syntax.operator", cssVar: "--syntax-operator", group: "syntax", kind: "color", deps: ["colors.foreground"], derive: (d) => { const v = d["colors.foreground"]; return v ? ensureContrast(v, d["colors.background"] || "#000", 4.5) : undefined; }, doc: "Operator color." },
