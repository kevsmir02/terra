...
export const TOKENS: readonly TokenDef[] = [
  ...
  { key: "colors.cardForeground", cssVar: "--card-foreground", group: "colors", kind: "textColor", deps: ["colors.foreground"], derive: (d) => d["colors.foreground"], doc: "Text on card surfaces." },
  ...
  { key: "syntax.number", cssVar: "--syntax-number", group: "syntax", kind: "color", derive: (d) => d.ansi?.[3], doc: "Number color." },
  { key: "syntax.constant", cssVar: "--syntax-constant", group: "syntax", kind: "color", derive: (d) => d.ansi?.[13], doc: "Constant color." },
  { key: "syntax.func", cssVar: "--syntax-func", group: "syntax", kind: "color", derive: (d) => d.ansi?.[4], doc: "Function color." },
  { key: "syntax.variable", cssVar: "--syntax-variable", group: "syntax", kind: "color", deps: ["colors.foreground"], derive: (d) => d["colors.foreground"], doc: "Variable color." },
  { key: "syntax.property", cssVar: "--syntax-property", group: "syntax", kind: "color", derive: (d) => d.ansi?.[6], doc: "Property color." },
  { key: "syntax.gutterFg", cssVar: "--syntax-gutter-fg", group: "syntax", kind: "color", derive: (d) => d.ansi?.[8], doc: "Gutter foreground color." },
  { key: "syntax.type", cssVar: "--syntax-type", group: "syntax", kind: "color", derive: (d) => d.ansi?.[14], doc: "Type color." },
  { key: "syntax.operator", cssVar: "--syntax-operator", group: "syntax", kind: "color", deps: ["colors.foreground"], derive: (d) => d["colors.foreground"], doc: "Operator color." },
  { key: "syntax.tag", cssVar: "--syntax-tag", group: "syntax", kind: "color", derive: (d) => d.ansi?.[1], doc: "Tag color." },
  { key: "syntax.tagBracket", cssVar: "--syntax-tag-bracket", group: "syntax", kind: "color", derive: (d) => d.ansi?.[8], doc: "Tag bracket color." },
  { key: "syntax.attr", cssVar: "--syntax-attr", group: "syntax", kind: "color", derive: (d) => d.ansi?.[11], doc: "Attribute color." },
  { key: "syntax.attrValue", cssVar: "--syntax-attr-value", group: "syntax", kind: "color", derive: (d) => d.ansi?.[2], doc: "Attribute value color." },
  { key: "syntax.heading", cssVar: "--syntax-heading", group: "syntax", kind: "color", derive: (d) => d.ansi?.[4], doc: "Heading color." },
  ...
  { key: "status.renamed", cssVar: "--status-renamed", group: "status", kind: "color", derive: (d) => d.ansi?.[4], doc: "Renamed status color." },
  { key: "status.warning", cssVar: "--status-warning", group: "status", kind: "color", derive: (d) => d.ansi?.[3], doc: "Warning status color." },
  { key: "status.conflict", cssVar: "--status-conflict", group: "status", kind: "color", derive: (d) => d.ansi?.[6], doc: "Conflict status color." },
  { key: "status.ok", cssVar: "--status-ok", group: "status", kind: "color", derive: (d) => d.ansi?.[2], doc: "OK status color." },
];
