...
const SIDEBAR_WIDTH_STORAGE_KEY = "terra.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "terra.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "terra.sidebar.collapsed";
...
function readSidebarView(): SidebarViewId {
  try {
    ...
    if (stored === "explorer" || stored === "source-control" || stored === "devices") return stored;
  } catch {
    // ignore
  }
  return "explorer";
