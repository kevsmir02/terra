...
const PILL_CLASS =
  "terra-label terra-pill-in flex h-5 shrink-0 cursor-pointer [&_button]:cursor-pointer items-center gap-1 rounded-pill border border-border/(--emph-medium) bg-accent/(--emph-medium) px-2 text-[10.5px] font-medium text-muted-foreground transition-colors duration-200 hover:bg-accent hover:text-foreground";
