...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-2xl border text-sm transition-colors terra-motion outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/(--emph-medium) [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
