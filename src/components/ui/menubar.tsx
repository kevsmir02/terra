...
function MenubarSeparator({
  ...
  return (
    <MenubarPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 h-px bg-border/(--emph-medium)", className)}
      {...props}
    />
  )
}
