...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-pill border-2 transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/(--emph-subtle) aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/(--emph-subtle) data-[size=default]:h-5 data-[size=default]:w-11 data-[size=sm]:h-4 data-[size=sm]:w-7 dark:aria-invalid:border-destructive/(--emph-medium) dark:aria-invalid:ring-destructive/(--emph-soft) data-checked:border-primary data-checked:bg-primary data-unchecked:border-transparent data-unchecked:bg-input/(--emph-bold) data-disabled:cursor-not-allowed data-disabled:opacity-50",
        className
      )}
      {...props}
    >
